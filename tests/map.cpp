...
TEST_CASE("map_numbers", "[map_numbers]")
{
    ...
    ss1 << mp1;
    ss2 << MAP_BEGIN << "1:10, 2:30, 3:50, 4:70" << MAP_END;
    REQUIRE(ss1.str() == ss2.str());

    ss1.str(std::string());
    ss2.str(std::string());
    ss1 << mp2;
    ss2 << MAP_BEGIN << "1.1:10, 2.3:30, 2.7:70, 9.1:50" << MAP_END;
    REQUIRE(ss1.str() == ss2.str());
}
...
TEST_CASE("map_string", "[map_string]")
{
    ...
    ss1 << mp_str1;
    ss2 << MAP_BEGIN << "\'1\':\"one\", \'2\':\"two\", \'3\':\"three\", \'4\':\"four\"" << MAP_END;
    REQUIRE(ss1.str() == ss2.str());
}
...
TEST_CASE("map_nested", "[map_nested]")
{
    ...
    ss1 << mp_str1;
    ss2 << MAP_BEGIN
        << "\'1\':" << MAP_BEGIN << "1:\"one\", 10:\"ten\"" << MAP_END
        << ", \'2\':" << MAP_BEGIN << "2:\"two\", 20:\"twenty\"" << MAP_END
        << ", \'3\':" << MAP_BEGIN << "3:\"three\", 30:\"thirty\", 32:\"thirty two\", 33:\"thirty three\"" << MAP_END
        << ", \'4\':" << MAP_BEGIN << "4:\"four\", 40:\"fourty\"" << MAP_END
		<< MAP_END;
    REQUIRE(ss1.str() == ss2.str());
}
